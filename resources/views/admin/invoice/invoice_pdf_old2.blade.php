              ...
              <tbody>
                <tr class="cs-table_baseline">
                  ...
                  <td class="cs-width_3 cs-text_right">
                    ...
                    <p class="cs-primary_color cs-bold cs-f16 cs-mb5 ">CGST {{$companydetail->cgst}} %:</p>
                    <p class="cs-primary_color cs-bold cs-f16 cs-mb5 ">SGST {{$companydetail->sgst}} %</p>
                    <p class="cs-primary_color cs-bold cs-f16 cs-mb5 ">Round Off</p>
                  ...
                  <td class="cs-width_3 cs-text_rightcs-f16">
                    ...
                    <p class="cs-primary_color cs-bold cs-f16 cs-mb5 cs-text_right"><?= $cgst ?></p>
                    <?php $sgst = $total * ($companydetail->sgst / 100) ?>
                    <p class="cs-primary_color cs-bold cs-f16 cs-mb5 cs-text_right"><?= $sgst ?></p>
                    <?php
                    $ground_total = $total + $cgst + $sgst;
                    $rounded_total = round($ground_total);
                    $round_difference = $rounded_total - $ground_total;
                    ?>
                    <p class="cs-primary_color cs-bold cs-f16 cs-mb5 cs-text_right"><?= number_format($round_difference, 2); ?></p>
                    <p class="cs-border"></p>
                    <p class="cs-primary_color cs-bold cs-f16 cs-mb5 cs-text_right"><?= $rounded_total ?></p>
                  </td>
                </tr>
              </tbody>
            </table>
