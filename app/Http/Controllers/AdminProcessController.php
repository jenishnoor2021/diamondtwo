    ...
    public function update(Request $request)
    {
        ...
        if ($process->designation == 'Grading' && isset($r_weight)) {
            ...
            if ($dimonds->shape != 'Round') {
                ...
                else if ($r_weight >= 0.50 && $r_weight <= 0.99)
